...
export default function Landing() {
    ...
    return (
        <div className="leading-normal tracking-normal text-primary-800  gradient">
            <nav className="fixed w-full z-30 top-0 text-primary-800 shadow-md bg-white">
            ...
            <div className="relative lg:mt-14">
                <svg viewBox="0 0 1428 174" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                    <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                        ...
                        <g transform="translate(-4.000000, 76.000000)" fill="#CCEEF2" fillRule="nonzero">
                            <path
